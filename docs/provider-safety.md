...
For a local runtime walkthrough, deployment shape matrix, and route contract, see [`local-provider-guide.md`](./local-provider-guide.md).
...
- Which deployment shape owns runtime configuration?
